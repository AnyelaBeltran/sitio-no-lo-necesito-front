            ...
            <div class="card-body p-md-5">
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" @submit.prevent="handleSubmit">
                    ...
                    <div class="alert alert-danger text-center" v-if="errors.length > 0">
                      <h3>Encontramos algunos errores en el formulario</h3>
                      <ul>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <input type="text" id="cedula" class="form-control" v-model="cedula" required />
                ...
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                  <img src="../assets/images/fondo-registro.jpg" class="img-fluid" alt="Sample image" />
                </div>
              </div>
            </div>
          </div>
